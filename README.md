...
#### Initiatives
- 👨‍🌾 [Ethereum Event Gardeners](https://about.ethevents.club/) - community fostering open and free Ethereum events ([ethereumeg](https://github.com/ethereumeg))
- 👁️ [Web3Privacy Now](https://web3privacy.info) - research & community for privacy in the Web3 industry ([web3privacy](https://github.com/web3privacy)) 
- 🇨🇿🇸🇰 [Gwei.cz](http://gwei.cz/) - local Czech/Slovak Ethereum community ([gweicz](https://github.com/gweicz))
- 💰 [BohemianDAO](https://bohemiandao.cz/) - non-profit grants DAO for local czech Ethereum projects ([gweicz/bohemiandao](https://github.com/gweicz/bohemiandao))
- 🏛️ [UTXO Foundation](https://utxo.foundation/) - non-profit organization serving as a legal backbone for events ([utxo-foundation](https://github.com/utxo-foundation))
